...
$(".crypto-tracker").on("click", function () {
  $("#dialog-confirm").dialog({
    ...
    buttons: {
      Deployed: function () {
        window.location.href =
          "https://nicoletr.github.io/project1-finance-tracker/";
      },
      Repo: function () {
        window.location.href =
          "https://github.com/nicoletr/project1-finance-tracker";
      },
    },
  });
});

$(".password-manager").on("click", function () {
  $("#dialog-confirm").dialog({
    resizable: false,
    height: "auto",
    width: 400,
    ...
    buttons: {
      Deployed: function () {
        window.location.href = "https://safe-headland-04957.herokuapp.com/";
      },
      Repo: function () {
        window.location.href =
          "https://github.com/nicoletr/project2-password-manager";
      },
    },
  });
});
